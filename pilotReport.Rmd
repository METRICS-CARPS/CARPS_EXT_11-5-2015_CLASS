...
At first the pilot calculated descriptive statistics over all trials, instead of over subject summaries, which wasted some time. The final results are calculated over subject sumarries. 
...
# Frustrating but figured it out - Descriptive statistics were calculated over per subject summaries, not over trials.
